    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2017, 9, 13, 15, 41, 26, 917447), editable=False, verbose_name='Created on')),
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='djobberbase.City', verbose_name='City')),
            ],
            options={
                'verbose_name': 'Job',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2017, 9, 13, 15, 41, 26, 919445), verbose_name='Created on')),
            ],
            options={
                'verbose_name': 'Search',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateTimeField(default=datetime.datetime(2017, 9, 13, 15, 41, 26, 918781))),
                ('ip', models.GenericIPAddressField()),
                ('stat_type', models.CharField(choices=[(b'A', 'Application'), (b'H', 'Hit'), (b'S', 'Spam')], max_length=1)),
